...
There are 13 fully funded PhD positions open in Machine Learning, Statistics, Logic, Language Technology, and Ethics at [Integreat, The Norwegian Centre for Knowledge-driven Machine Learning.](https://integreat.no). You can find out [here](https://www.jobbnorge.no/en/available-jobs/job/257181/13-phd-positions-in-knowledge-driven-machine-learning).  

You can work with me on the Project 7 "Discrepancy measures and accelerated likelihood-free inference for simulator-based models". 
